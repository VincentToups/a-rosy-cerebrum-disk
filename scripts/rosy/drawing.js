define(["hooves/operator-functions", "hooves/lisp-idioms", "rosy/utils"], (function (moduleminus58c4bce870, moduleminus295baa4e1e, moduleC47fa390df)  {
  var currentModuleminus42961 = {    
    
  };
  var setModuleObject = (function (value)    {
    currentModuleminus42961 = value;
    });
  ((function ()    {
    ...
    currentModuleminus42961.withJitter = (function (context, n, magnitude, thunk)      {
      for (var i = 0;moduleminus58c4bce870.lessThan(i, n);i = moduleminus58c4bce870.plus(i, 1))        {
        (function (arguments)          {
          var context43089 = context;
          context43089.save();
          try            {
  ...
  return currentModuleminus42961;
  }))